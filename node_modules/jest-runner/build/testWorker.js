'use strict';
/* build-hook-start *//*00001*/try { require('/users/hakima/.vscode/extensions/wallabyjs.console-ninja-0.0.189/out/buildhook/index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///users/hakima/.vscode/extensions/wallabyjs.console-ninja-0.0.189/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
